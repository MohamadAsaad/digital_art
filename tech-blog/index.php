...
if (empty($posts)) {
    echo "لا توجد مقالات منشورة حالياً";
} else {
    foreach ($posts as $post) {
        echo "<div class='post-card'>";
        echo "<h2>" . $post['title'] . "</h2>";
        echo "<p>بواسطة: " . ($post['users']['username'] ?? 'مجهول') . "</p>";
        echo "<p>التصنيف: " . ($post['categories']['name'] ?? 'بدون تصنيف') . "</p>";
        echo "</div>";
    }
}
?>
...
<header>
    <div class="container">
        <div class="header-content">
            ...
            <a href="/tech_blog/index.php" class="logo">
